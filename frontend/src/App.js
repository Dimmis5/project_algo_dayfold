      ...
      <div className="flex h-screen bg-white font-sans text-gray-900">
        ...
        <aside className="w-20 flex flex-col items-center py-6 border-r border-gray-100 space-y-8">
          ...
          <div className="mt-auto pb-4 flex flex-col gap-6 items-center">
            ...
            <button onClick={handleLogout} className="text-[10px] font-black text-gray-400 hover:text-red-500 uppercase tracking-tighter">Sortir</button>
          </div>
        </aside>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <header className="h-20 flex items-center px-8 gap-4">
            ...
            <button className="p-2 hover:bg-gray-100 rounded-full text-xl">⚙️</button>
          </header>
